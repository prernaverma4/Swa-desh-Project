...
def add_sugarcane_product():
    with app.app_context():
        ...
        product_data = {
            "name": "SugarCane",
            "description": "High-quality sugarcane from Gopalganj, Bihar, known for its sweetness and high yield. (Price per Quintal)",
            "price": 450.0, # Average of 400-500
            "stock": 200,
            "district": "Gopalganj",
            "state": "Bihar",
            # Image found: sugarcane_4016a507b2.jpg
            "image_url": "/static/img/products/sugarcane_4016a507b2.jpg",
