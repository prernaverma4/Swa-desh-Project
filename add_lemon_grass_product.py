...
def add_lemon_grass_product():
    with app.app_context():
        ...
        product_data = {
            "name": "Lemon Grass",
            "description": "Aromatic Lemon Grass oil from Banka, Bihar. Used in culinary, medicinal, and cosmetic applications. (Price per Litre)",
            "price": 1300.0, # Average of 1200 - 1400
            "stock": 60,
            "district": "Banka",
            "state": "Bihar",
            # Image found: lemon_grass_8439d7a9d0.jpg
            "image_url": "/static/img/products/lemon_grass_8439d7a9d0.jpg",
