...
def add_silk_product():
    with app.app_context():
        ...
        product_data = {
            "name": "Silk",
            "description": "World-famous Bhagalpuri Silk, known as 'Queen of all fabrics'. Elegant texture and durability. (Price per Kg/Unit)",
            "price": 900.0, # Average of 60 - 1800
            "stock": 100,
            "district": "Bhagalpur",
            "state": "Bihar",
            # Image found: bhagalpur_silk_2f4a78283d.png
            "image_url": "/static/img/products/bhagalpur_silk_2f4a78283d.png",
