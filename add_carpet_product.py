...
def add_carpet_product():
    with app.app_context():
        ...
        product_data = {
            "name": "Carpet",
            "description": "Handwoven carpets from Aurangabad, Bihar. Intricate designs and high durability. (Price per Piece)",
            "price": 300.0, # Average of 50 - 500
            "stock": 80,
            "district": "Aurangabad",
            "state": "Bihar",
            # Image found: carpet_26671772d7.jpg
            "image_url": "/static/img/products/carpet_26671772d7.jpg",
