...
def add_tilkut_product():
    with app.app_context():
        ...
        product_data = {
            "name": "Tilkut",
            "description": "A traditional sweet made from sesame seeds and jaggery or sugar, famous in Gaya, Bihar.",
            "price": 600.0, # Average of 200-1000
            "stock": 40,
            "district": "Gaya",
            "state": "Bihar",
            # Image provided by user: 40367.jpg
            "image_url": "/static/img/products/40367.jpg",
