...
def add_silao_khaja_product():
    with app.app_context():
        ...
        product_data = {
            "name": "Silao Khaja",
            "description": "A traditional multi-layered crispy sweet from Nalanda, Bihar. Geographical Indication (GI) tagged.",
            "price": 250.0, # Average of 200-300
            "stock": 80,
            "district": "Nalanda",
            "state": "Bihar",
            # Image found: silao_khaja_f16c1730a6.webp
            "image_url": "/static/img/products/silao_khaja_f16c1730a6.webp",
