...
def add_mentha_product():
    with app.app_context():
        ...
        product_data = {
            "name": "Mentha (Mint)",
            "description": "High-quality Mentha (Mint) oil and products from Siwan, Bihar. Used in medicines and flavoring. (Price per Kg)",
            "price": 1000.0, # Average of 900 - 1100
            "stock": 100,
            "district": "Siwan",
            "state": "Bihar",
            # Image found: mentha_307af93265.jpg
            "image_url": "/static/img/products/mentha_307af93265.jpg",
