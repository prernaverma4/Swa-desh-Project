...
def add_shahi_litchi_product():
    with app.app_context():
        ...
        product_data = {
            "name": "Shahi Litchi",
            "description": "Famous sweet, juicy, and aromatic litchi from Muzaffarpur, Bihar. Has a GI tag.",
            "price": 200.0, # Average of 100-300
            "stock": 100,
            "district": "Muzaffarpur",
            "state": "Bihar",
            # Image provided by user: product-jpeg.jpg
            "image_url": "/static/img/products/product-jpeg.jpg",
