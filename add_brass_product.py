...
def add_brass_product():
    with app.app_context():
        ...
        # 2. Product Details
        product_data = {
            "name": "Brass Utensil Work",
            "description": "Traditional brass utensil crafting from Patna, Bihar. Durable and artistically designed.",
            "price": 3100.0, # Average of 200 - 6000
            "stock": 30,
            "district": "Patna",
            "state": "Bihar",
            # Image found: brass_metal_work_ba705ef109.jpg
            "image_url": "/static/img/products/brass_metal_work_ba705ef109.jpg",
