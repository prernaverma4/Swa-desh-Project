...
def add_handloom_product():
    with app.app_context():
        ...
        product_data = {
            "name": "Handloom",
            "description": "Exquisite Handloom fabrics from Nawada, Bihar. Known for quality and traditional weaving techniques. (Price per Meter Fabric)",
            "price": 800.0, # Average of 100 - 1500
            "stock": 150,
            "district": "Nawada",
            "state": "Bihar",
            # Image found: handloom_25d26f7b2e.jpg
            "image_url": "/static/img/products/handloom_25d26f7b2e.jpg",
