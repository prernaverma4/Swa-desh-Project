...
def add_stone_art_product():
    with app.app_context():
        ...
        product_data = {
            "name": "Stone Art",
            "description": "Exquisite stone carvings and sculptures from Kaimur, Bihar. Ranging from small decorative pieces to large installations.",
            "price": 1500.0, # Average price point within the wide range (300 - 1,00,000)
            "stock": 40,
            "district": "Kaimur",
            "state": "Bihar",
            # Image found: stone_art_b10a9a1a99.jpg
            "image_url": "/static/img/products/stone_art_b10a9a1a99.jpg",
