...
def add_banana_product():
    with app.app_context():
        ...
        product_data = {
            "name": "Banana",
            "description": "Premium quality bananas from Vaishali, Bihar. Known for their sweet taste and nutritional value. (Price per Dozen)",
            "price": 40.0, # Average of 25 - 60
            "stock": 500,
            "district": "Vaishali",
            "state": "Bihar",
            # Image found: banana_e4884a955a.jpg
            "image_url": "/static/img/products/banana_e4884a955a.jpg",
