...
def add_jute_product():
    with app.app_context():
        ...
        product_data = {
            "name": "Jute",
            "description": "Eco-friendly and sustainable Jute from Katihar, Bihar. Used for bags, ropes, and mats. (Price per Quintal equivalent)",
            "price": 5200.0, # Average of 4800-5600
            "stock": 50,
            "district": "Katihar",
            "state": "Bihar",
            # Image found: jute_9d3b04e272.jpg
            "image_url": "/static/img/products/jute_9d3b04e272.jpg",
